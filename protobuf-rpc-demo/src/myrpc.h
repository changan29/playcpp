...
{
public:
    DoneParams(::google::protobuf::Message *recv_msg_,
               ::google::protobuf::Message *resp_msg_,
               boost::shared_ptr<boost::asio::ip::tcp::socket> sock_)
        : recv_msg(recv_msg_), resp_msg(resp_msg_), sock(sock_)
    {
    }
...
void MyServer::on_resp_msg_filled( DoneParams params) {
    boost::scoped_ptr<::google::protobuf::Message> recv_msg_guard(params.recv_msg);
    boost::scoped_ptr<::google::protobuf::Message> resp_msg_guard(params.resp_msg);
